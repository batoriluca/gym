      ...
      <div className={style.navbar}>
        <div className={style.navbar_title}>
          <div className={style.socialmed}>
            <Image src="/img/Group_1.png" alt={"Not Found"}  width={40} height={40} />
            <a target="_blank" href="https://www.instagram.com/growyourmusic.ro/"><i className="fa-brands fa-instagram" /></a>
            <a target="_blank" href="https://www.youtube.com/channel/UC7WCSzZMpwCOn4BLiNf1aGQ"><i className="fa-brands fa-youtube" /></a>
            <a target="_blank" href="https://www.tiktok.com/@growyourmusic.ro"><i className="fa-brands fa-tiktok" /></a>
          </div>
        </div>
